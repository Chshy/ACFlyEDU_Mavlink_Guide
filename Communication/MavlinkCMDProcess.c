...
static void Cmd400_MAV_CMD_COMPONENT_ARM_DISARM( uint8_t port_index , const mavlink_message_t* msg )
{
	...
	if
	( 
		( current_Mode = 35 ) &&	//当前为M35模式
		( mav_mode & MAV_MODE_FLAG_GUIDED_ENABLED )	//当前Guided=True
	)
	{	
		change_Mode( msg_rd->param2 );
	}
...
void (*const Mavlink_CMD_Process[])( uint8_t port_index , const mavlink_message_t* msg_rd ) = 
{
	...
	/*019-*/	0	,
	/*020-*/	0	,
	/*021-*/	Cmd21_MAV_CMD_NAV_LAND,//zzw
    /*022-*/	Cmd22_MAV_CMD_NAV_TAKEOFF	,//zzw
	/*023-*/	0	,
	/*024-*/	0	,
	/*025-*/	0	,
	/*026-*/	0	,
	...
	/*520-*/	Cmd520_MAV_CMD_REQUEST_AUTOPILOT_CAPABILITIES	,//zzw
	/*521-*/	0	,
	/*522-*/	0	,
	/*523-*/	0	,
	/*524-*/	0	,
